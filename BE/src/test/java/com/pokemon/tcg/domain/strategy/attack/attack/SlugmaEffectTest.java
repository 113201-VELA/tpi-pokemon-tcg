...
class SlugmaEffectTest {

    private SlugmaEffect effect;
    ...
    @BeforeEach
    void setUp() {
        effect = new SlugmaEffect();
    }

    @Test
    void apply_shouldDiscardSpecifiedEnergy_fromSlugma() {
    ...
    private AttackContext buildContext(List<String> attachedEnergies,
        ...
        ActivePokemon slugma = ActivePokemon.builder()
                .instanceId("slugma-1")
                .cardId("xy1-20")
        ...
        attackerState.setActivePokemon(slugma);
        ...
        payload.put("attackName", "Flamethrower");
