...
import com.pokemon.tcg.domain.strategy.attack.attack.BeedrillEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.BraixenEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.ChespinEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.ChesnaughtEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.GogoatEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.IllumiseEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.KakunaEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.LedianEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.MagcargoEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.PansageEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.PansearEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.QuilladinEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.SimisageEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.SimisearEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.SkiddoEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.SlugmaEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.SpewpaEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.VivillonEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.VolbeatEffect;
import com.pokemon.tcg.domain.strategy.attack.attack.WeedleEffect;
